...
from utils.hog import image_to_hog
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        edge, gray_image = image_to_edge(image * mask, sigma=self.sigma)
        hog_image = image_to_hog(image * mask)

        return image, mask, edge, gray_image, hog_image
