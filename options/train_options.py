...
class TrainOptions:
    ...
    def __init__(self):
        ...
        parser.add_argument('--save_dir', type=str, default='snapshots/Places2/Base_Full')
        parser.add_argument('--log_dir', type=str, default='runs/Places2/Base_Full')
        ...
        parser.add_argument('--train_iter', type=int, default=400000)
        ...
        parser.add_argument('--ADVERSARIAL_LOSS', type=float, default=1.0)
